(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["BOValidasi"],{
  ...
  function() {
    ...
    return _c("div", { staticClass: "br-pageheader pd-y-15 pd-md-l-20" }, [
      _c("nav", { staticClass: "breadcrumb pd-0 mg-0 tx-12 tx-warning" }, [
        _c(
          "span",
          { staticClass: "breadcrumb-item tx-warning", attrs: { href: "#" } },
          [
            _c("span", { staticClass: "tx-warning tx-bold" }, [
              _vm._v("BACK OFFICE VALIDASI DAN KEABSAHAN BERKAS")
            ])
          ]
        )
      ])
