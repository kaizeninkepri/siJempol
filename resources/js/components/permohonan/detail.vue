...
<div>
    <div class="br-subleft">
        ...
        <h6 class="tx-uppercase tx-15 mg-t-40 pd-x-10 bd-b pd-b-10 tx-roboto tx-white-7">
            DATA PERUSAHAAN
        </h6>
    ...
    <div class="br-contentpanel">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            ...
            <el-button type="primary" size="medium">Cetak Checklist Serah Terima</el-button>
        </div>
        ...
        <template slot="title">
            <div>
                <div class="d-flex align-items-center justify-content-between mg-b-30">
                    <div>
                        <el-select v-model="pratinjau.persyaratan.catatan" placeholder="Select" v-if="pratinjau.persyaratan" @change="
                  toStatusPersyaratan(
