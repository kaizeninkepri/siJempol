      ...
      <div v-else key="warning">
        <div class="br-msg-header d-flex justify-content-between">
          <div class="pd-x-0 pd-t-30">
            <h4 class="tx-gray-800 mg-b-5">DATA PERMOHONAN</h4>
        ...
        <div class="br-pagebody">
          ...
          <el-card>
            ...
            >
              ...
              <el-table-column prop="permohonan_code" label="Kode Permohonan"></el-table-column>
              <el-table-column prop="perusahaan.fullname" label="Nama Perusahaan"></el-table-column>
              <el-table-column prop="izin.nama_izin" label="Nama Izin"></el-table-column>
              <el-table-column prop="lastjam" label="Tanggal pengjaun"></el-table-column>
...
export default {
  ...
  computed: {
    ...
    tabledata() {
      ...
      const filter = (event) =>
        event.perusahaan.npwp.toLowerCase().includes(filterValue) || 
