        ...
        <div v-else key="warning">
            <div class="br-msg-header d-flex justify-content-between">
                <div class="pd-x-0 pd-t-30">
                    <h4 class="tx-gray-800 mg-b-5">PENGGUNAAN APLIKASI SIJEMPOL</h4>
            ...
            <div class="br-pagebody">
                <el-card>
                  ...
                  || data.value.toLowerCase().includes(table.search.toLowerCase()) 
                        ...
                        <el-table-column prop="nama" label="Nama File"></el-table-column>
                        <el-table-column prop="address" label="Aksi" width="180">
                            <template slot-scope="scope">
                                <a :href="scope.row.url" target="_blank">
                                    <i class="el-icon-printer"></i> Cetak
                                </a>
                            </template>
                        </el-table-column>
                    </el-table>
        ...
        return {
            ...
            table: {
                ...
                data: [{
                        ...
                        url: urlBase.web + '/public/tatacaradokumen/pemohon_jobdescription.pdf'
                    },
                    {
                        nama: "Peraturan Gubernur Nomor 84 Tahun 2019",
                        url: urlBase.web + '/public/tatacaradokumen/pergub_84 tahun_2019.pdf'
                    }
                ],
                size: 10,
                page: 1,
