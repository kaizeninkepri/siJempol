...
<div>
    <transition mode="out-in" name="fade">
        ...
        <div v-else key="warning">
            <div style="background:#3146A4; min-height:400px; border-top:1px solid #C8B046; color:white">
            ...
            <div class="br-pagebody" style="margin-top:-230px">
                <el-row :gutter="10">
                    ...
                    <el-col :md="4" :xs="{span:22, offset:1}">
                        <el-card class="card-feature">
                            <img :src="url.assets+'/images/files.png'" class="img-fluid">
                            <div class="bottom clearfix">
                                <el-button type="text" class="button" @click="FocusInpencarian()">Regulasi</el-button>
                            </div>
                        </el-card>
                    </el-col>
                    <el-col :md="4" :xs="{span:22, offset:1}">
                ...
                <el-row :gutter="10" class="mg-t-10">
                    <el-col :md="{span:4, offset : 4}" :xs="{span:22, offset:1}">
                        <el-card class="card-feature">
                            <img :src="url.assets+'/images/files.png'" class="img-fluid">
                            <div class="bottom clearfix">
                ...
                <el-row :gutter="10">
                    ...
                    <el-col :md="10" :xl="6">
                        <el-card class="mg-b-10">
                            <h6 class="tx-bold">DATA PENGAJUAN PERMOHONAN</h6>
