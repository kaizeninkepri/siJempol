  ...
  <div>
    ...
    <div class="br-pagebody">
      ...
      <div v-if="active.card[0]">
        <div class="card" v-if="!table.permintaan.data.length">
          <div class="card-body">
        ...
        <div class="card" v-if="table.permintaan.data.length">
          <div class="card-body">
            ...
            >
              ...
              <el-table-column prop="nomor_sk" label="Nomor SK" header-align="center"></el-table-column>
              <el-table-column
                prop="updated_at"
                label="Waktu Selesai"
                header-align="center"
              ...
              <el-table-column align="center">
                ...
                <template slot-scope="scope">
                  <a
                    :href="url.file+'/storage/app/permohonan/'+scope.row.permohonan.permohonan_code+'/sk/'+scope.row.file_sk"
