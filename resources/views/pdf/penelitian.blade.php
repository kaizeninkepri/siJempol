<html>
     ...
     @php($nomorsk = substr($p->permohonan_code, -4))
       ...
       <table align='center'>
           <tr class='judul'>
               ...
               <td class='judul'>
                   <img src="data:image/png;base64, {{ base64_encode(QrCode::format('png')->size(100)->generate($p->permohonan_code.'/2n.1/DPMPTSP/2021')) }}" width=40px>                   
               </td>
           </tr>
       </table>
       </span>
    ...
    <table class="tablePD5">
     ...
     <table class="tablePD5">
        <tr>
            ...
            <td valign="top">:</td>
            <td valign="top">
               {{ucwords(strtolower($p->penelitian->person->nama))}}
            </td>
        </tr>
        <tr>
            <td valign="top">b.</td>
            ...
            <td valign="top">
                 ...
                 {{ucwords(strtolower($p->penelitian->person->Identitas_nomor))}} /
                 {{ucwords(strtolower($p->penelitian->universitas))}} /
                 {{ucwords(strtolower($p->penelitian->person->jurusan))}} /
                 {{ucwords(strtolower($p->penelitian->person->jenjang))}}  
            </td>
        </tr>
        <tr>
            <td valign="top">c.</td>
            ...
            <td valign="top">:</td>
            <td valign="top">Melakukan Penelitian, dengan judul <b>"{{$p->penelitian->judul}}"</b></td>
        </tr>
        <tr>
            <td valign="top"></td>
            <td valign="top"></td>
    ...
    Demikian Rekomendasi ini dibuat Untuk dipergunakan Sebagaimana Mestinya. <br/><br/><br/>
     ...
     <div class="ttdbarcode">
       <br/><br/><br/><br/><br/>
       @if($p->status == 'selesai')
         <img src="{{url('public/images/kabid.png')}}" width=50px>
       @elseif($p->status == 'selesai' OR $p->status == 'SelesaiPenyerahan')
           <img src="{{url('public/images/kabid.png')}}" width=50px>
       @else
    ...
    <div class="ttdmanual">
        ...
        @if($p->status == 'selesai' OR $p->status == 'SelesaiPenyerahan' )
            <img src="{{url('public/images/kadis.png')}}" width=80px>
            <div style=""></div>
        @else
